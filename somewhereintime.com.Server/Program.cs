...
using somewhereintime.ServiceDefaults;
...
logger.LogInformation("Starting somewhereintime.com.Server (Environment: {env})", app.Environment.EnvironmentName);
...
var clientDist = Path.GetFullPath(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "somewhereintime.com.client", "dist"));
...
{
    logger.LogInformation("Shutting down somewhereintime.com.Server");
}
