...
namespace somewhereintime.com.AppHost
{
    ...
    public sealed class EmbeddedProjectMetadata : IProjectMetadata
    {
        ...
        public string Id => Env("APP_PROJECT_ID", "somewhereintime-com-server");

        public string DisplayName => Env("APP_PROJECT_DISPLAY_NAME", "somewhereintime.com Server");
        ...
        public string ProjectAssemblyName => Env("APP_PROJECT_ASSEMBLY", "somewhereintime.com.Server");
